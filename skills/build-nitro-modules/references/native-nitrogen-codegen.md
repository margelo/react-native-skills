...
│   ├── c++/
│   └── swift/
│       └── HybridMathSpec.swift       ← Swift protocol/base spec (DO NOT EDIT)
├── android/
...
└── shared/
    └── c++/
        ...
        └── HybridMathSpec.cpp         ← Generated C++ glue (DO NOT EDIT)
```
...
### Example generated Swift spec shape (read-only)
...
Older generated Swift specs may use a single protocol instead of the protocol/base typealias, but implementation code should still inherit or conform to `HybridMathSpec` and should not edit this file.
